                                    ...
                                    <div class="input-group-btn search-panel">
                                        ...
                                        <select name="cat" id="first-cat" class="form-select rounded-0">
                                            ...
                                            <?php foreach (getParentCategoryArray() as $catTop) {
                                                ...
                                                <option value="<?php echo $catTop->prod_cat_id; ?>" <?php echo ($tCat == $catTop->prod_cat_id) ? 'selected' : ''; ?>>
                                            ...
                                            <?php if (!empty(count(getCategoryBySubArray($pcat->prod_cat_id)))) { ?>
                                                <ul class="dropdown-menu dropdown-submenu">
                                                    <?php foreach (getCategoryBySubArray($pcat->prod_cat_id) as $sCat) { ?>
                                                        <li><a class="dropdown-item" href="<?php echo base_url('category/' . $sCat->prod_cat_id); ?>">
                                                                <?php if (!empty(count(getCategoryBySubArray($sCat->prod_cat_id)))) { ?>
                                                                    <i class="fa-solid fa-angle-right  float-end " style="margin-top: 4px;"></i>
                                                                <?php } ?>
                                        ...
                                        <?php foreach (getSideMenuArray() as $pcat) { ?>
                                            <li>
                                                ...
                                                <?php if (!empty(count(getCategoryBySubArray($pcat->prod_cat_id)))) { ?>
                                                    <ul class="dropdown-menu dropdown-submenu">
                                                        <?php foreach (getCategoryBySubArray($pcat->prod_cat_id) as $sCat) { ?>
                                                            <li><a class="dropdown-item" href="<?php echo base_url('category/' . $sCat->prod_cat_id); ?>"><?php echo $sCat->category_name; ?></a>
                                                            </li>
                                                        <?php } ?>
                                                    </ul>
                                                <?php } ?>
