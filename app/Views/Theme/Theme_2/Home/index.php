                                        ...
                                        <div class="products  <?php echo ($key == '0') ? 'active' : ''; ?> p-md-4  text-center">
                                            ...
                                            <div class="text ic-pp-btn">
                                                <p class="cat-title-side">
                                                    <?php echo get_data_by_id('category_name', 'cc_product_category', 'prod_cat_id', $catPop->prod_cat_id); ?>
                                                </p>
                                                <p class="cat-text-side">
                                                    <?php echo substr(get_data_by_id('description', 'cc_product_category', 'prod_cat_id', $catPop->prod_cat_id), 0, 30); ?>
                                                </p>
                                                <a href="#" class="bg-custom-color">
                                                    <svg class="mt-2 bg-custom-color" style="background-color:#c12d25 !important;" xmlns="http://www.w3.org/2000/svg" width="40" height="39" viewBox="0 0 40 39" fill="none">
